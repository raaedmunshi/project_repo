...
public class UpdateDeleteProfessor extends javax.swing.JFrame {
    ...
    private void getNewData() {
        ...
        try {
            rs = mycon.getstate().executeQuery("SELECT * FROM professors ORDER BY p_id ASC ");
            rs.beforeFirst();
            rs.first();
            populateFields();
    ...
    private void populateFields() {
        try {
            ...
            cmbDept.setSelectedItem(rs.getString("dept"));
            ...
            Logger.getLogger(UpdateDeleteProfessor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        cmbDept.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            ...
            if (isValidData()) {
                prepStatement = mycon.getCon().prepareStatement("UPDATE professors name=?, gender=?, dept=?, age=? where s_id = ?");

                prepStatement.setString(1, txtName.getText());
                if(cmbDept.getSelectedItem()=="Male")
                    prepStatement.setString(2,"M");
                else
                    prepStatement.setString(2,"F");
                prepStatement.setString(3, cmbDept.getSelectedItem().toString());
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            // make the result set scrolable forward/backward updatable
            prepStatement = mycon.getCon().prepareStatement("DELETE professors WHERE p_id = " + txtID.getText().trim());
            int result = prepStatement.executeUpdate();
            if (result > 0) {
